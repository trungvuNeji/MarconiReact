      ...
      <div className="main-box text-center advisor-box team-box padding-top padding-botom">
        ...
        <div className="team-section col-xs-12 no-padding">
          <div className="team-small-box">
            ...
            <a href="https://www.linkedin.com/in/ligeorge/"><i className="fa fa-linkedin"></i></a>
          </div>
          <div className="team-small-box">
            <figure>
            ...
            <a href="https://www.linkedin.com/in/matthewliu/"> <i className="fa fa-linkedin"></i></a>
          </div>
          <div className="team-small-box">
            <figure>
            ...
            <a href="https://www.linkedin.com/in/jaysrinivasan1/"> <i className="fa fa-linkedin"></i></a>
          </div>
          <div className="team-small-box">
            <figure>
            ...
            <a href="https://www.linkedin.com/in/joyce-kim-a8951322/"> <i className="fa fa-linkedin"></i></a>
          </div>
        </div>
        ...
        <div className="team-section col-xs-12 no-padding">
          <div className="team-small-box">
            ...
            <a href="https://www.linkedin.com/in/glenn-entis-40066a7/"> <i className="fa fa-linkedin"></i></a>
          </div>
